...
while start_game == True:
  ...
  if start == '1':
    ...
    print("Normal mode, where you will have six guesses to guess a five letter word.")
    print("Hard mode, where you will have seven guesses to guess 2 five letter words")
    print("Finally, Super Hard Mode, where you will have eight guesses to guess 4 five letter words")
    ...
    print('It will return green')
    print('If the letters in your guess are in the word but not in the same position')
    print('It will return Yellow')
    print('If the letter is not in the word at all. It will return red')
